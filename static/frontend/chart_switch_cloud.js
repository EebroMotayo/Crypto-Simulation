...
function syncToInterval(interval) {
	...
	if(interval == "SMA CrossOver"){
		...
		if(chartData0 == "Open"){
			...
			fetch('http://127.0.0.1:5000/chartz_runbot_ema_cloud_base/'+tradePair+'/4h')
			.then((r) => r.json())
			.then((response) => {
				//console.log(response)
			...
			fetch('http://127.0.0.1:5000/chartz_runbot_ema_cloud/'+tradePair+'/4h')
			.then((r) => r.json())
			.then((response) => {
				//console.log(response)
			...
			fetch('http://127.0.0.1:5000/chartz_runbot_ema_cloud_crossover/'+tradePair+'/4h')
			.then((r) => r.json())
			.then((response) => {
				//console.log(response)
