...
function load_chart_backtest(tradePair, timeFrame, date_backtest){
	...
	fetch('http://127.0.0.1:5000/chartz_runbot_ema_cloud_base/'+tradePair+'/'+timeFrame)
	.then((r) => r.json())
	.then((response) => {
	...
	fetch('http://127.0.0.1:5000/chartz_runbot_ema_cloud/'+tradePair+'/'+timeFrame)
	.then((r) => r.json())
	.then((response) => {
	...
	fetch('http://127.0.0.1:5000/chartz_runbot_ema_cloud_crossover/'+tradePair+'/'+timeFrame)
	.then((r) => r.json())
	.then((response) => {
